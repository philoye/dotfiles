" Vim color file
" Converted from Textmate theme Sunburst using Coloration v0.2.3 (http://github.com/sickill/coloration)
...
hi Visual  guifg=NONE guibg=#61000f gui=NONE
...
hi PmenuSel  guifg=NONE guibg=#61000f gui=NONE
hi IncSearch  guifg=NONE guibg=#142d4b gui=NONE
hi Search  guifg=NONE guibg=#142d4b gui=NONE
hi Directory  guifg=#2e78b7 guibg=NONE gui=NONE
hi Folded  guifg=#4f4f4f guibg=#000000 gui=NONE

hi Normal  guifg=#f8f8f8 guibg=#000000 gui=NONE
hi Boolean  guifg=#2e78b7 guibg=NONE gui=NONE
hi Character  guifg=#2e78b7 guibg=NONE gui=NONE
hi Comment  guifg=#4f4f4f guibg=NONE gui=italic
hi Conditional  guifg=#e28964 guibg=NONE gui=NONE
hi Constant  guifg=#2e78b7 guibg=NONE gui=NONE
hi Define  guifg=#e28964 guibg=NONE gui=NONE
hi ErrorMsg  guifg=NONE guibg=NONE gui=NONE
hi WarningMsg  guifg=NONE guibg=NONE gui=NONE
hi Float  guifg=#2e78b7 guibg=NONE gui=NONE
...
hi Number  guifg=#2e78b7 guibg=NONE gui=NONE
...
hi Todo  guifg=#4f4f4f guibg=NONE gui=inverse,bold,italic
...
hi rubySymbol  guifg=#2e78b7 guibg=NONE gui=NONE
...
hi rubyEscape  guifg=#2e78b7 guibg=NONE gui=NONE
...
hi erubyComment  guifg=#4f4f4f guibg=NONE gui=italic
...
hi htmlSpecialChar  guifg=#2e78b7 guibg=NONE gui=NONE
